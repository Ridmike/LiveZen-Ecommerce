    ...
    <div className="bg-gray-50">
      <div className="mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="sm:flex sm:items-baseline sm:justify-between">
          <p className="text-2xl font-bold tracking-tight text-gray-900">Shop by Category</p>
          <a href="/all-products" className="hidden text-sm font-semibold text-indigo-600 hover:text-indigo-500 sm:block">
        ...
        <div className="mt-6 sm:hidden">
          <a href="/all-products" className="block text-sm font-semibold text-indigo-600 hover:text-indigo-500">
            Browse all categories
            <span aria-hidden="true"> &rarr;</span>
          </a>
        </div>
